<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
            ...
            <div>
                <x-jet-label for="tab_no" value="{{ __('Tab No') }}" />
                <x-jet-input id="tab_no" class="block mt-1 w-full" type="text" name="tab_no" :value="old('tab_no')" required autofocus autocomplete="tab_no" />
            </div>
